          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="body2-semi md:body1-semi">
                  Làm thế nào để cải thiện phản xạ ngôn ngữ khi nói Tiếng Trung?
                </AccordionTrigger>
                <AccordionContent className="body3 md:body2-regular">
            ...
            <div className="pt-10">
              <p className="body2-semi md:body1-semi">Bạn vẫn thắc mắc...</p>
              <span className="body3 font-semibold md:body2-semi">
